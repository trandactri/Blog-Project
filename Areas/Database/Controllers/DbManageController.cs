...
namespace App.Areas.Database.Controllers
{
    ...
    public class DbManageController : Controller
    {
        ...
        public DbManageController(MyBlogContext dbContext, UserManager<AppUser> userManager, RoleManager<IdentityRole> roleManager)
        {
        ...
        public async Task<IActionResult> DeleteDbAsync()
        {
            ...
            StatusMessage = success ? "Successfully delete db" : "Cannot delete db";
        ...
        public async Task<IActionResult> Migrate()
        {
            ...
            StatusMessage = "Successfully migrate db";
        ...
        public async Task<IActionResult> SeedDataAsync()
        {
            ...
            StatusMessage = "Seed db successfully";
        ...
        private void SeedPostCategory()
        {
            ...
            int cm = 1;
            fakerCategory.RuleFor(c => c.Title, fk => $"Cate{cm++} " + fk.Lorem.Sentence(1, 2).Trim('.'));
            ...
            fakerPost.RuleFor(p => p.ImageFile, f => f.Image.PicsumUrl());
            ...
            fakerPost.RuleFor(p => p.Title, f => $"Post {postOrd++} " + f.Lorem.Sentence(3, 4).Trim('.'));
