    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string? returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("Cannot sign in");
                    return View(model);
                }
            }
            return View(model);
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string? returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    _logger.LogInformation("Created new member.");
                    ...
                    await _emailSender.SendEmailAsync(model.Email, 
                        ...
                        @$"Bạn đã đăng ký tài khoản trên Blog Project, 
                    ...
                    else 
                    {
                        ...
                        /*
                            info => user1 (mail1@abc.com)
                                 => user2 (mail2@abc.com)
                        */
                        ModelState.AddModelError(string.Empty, "Cannot connect to account, please use another email");
                        return View();
                    }
                }


                if (((externalEmailUser != null) && (registeredUser == null)) || externalEmail != model.Email)
                {
                    ModelState.AddModelError(string.Empty, "No support for signing up new account, email different from external login");
                    return View();                    
                }
