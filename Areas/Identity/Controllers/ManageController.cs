    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index(ManageMessageId? message = null)
        {
            ViewData["StatusMessage"] =
                ...
                : message == ManageMessageId.AddPhoneSuccess ? "Phone Num has been added."
                : message == ManageMessageId.RemovePhoneSuccess ? "Phone Num has been removed."
                : "";
        ...
        public async Task<IActionResult> ManageLogins(ManageMessageId? message = null)
        {
            ViewData["StatusMessage"] =
                ...
                : message == ManageMessageId.AddLoginSuccess ? "External Login has been added."
                : message == ManageMessageId.Error ? "An error occurred."
                : "";
            var user = await GetCurrentUserAsync();
            if (user == null)
        ...
        public async Task<IActionResult> VerifyPhoneNumber(VerifyPhoneNumberViewModel model)
        {
            ...
            ModelState.AddModelError(string.Empty, "An error occurred when adding phone num");
            return View(model);
        }
        //
